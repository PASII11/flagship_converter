...
datas = [('C:\\Users\\0\\PycharmProjects\\flagship\\.venv\\Lib\\site-packages\\rapidocr', 'rapidocr')]
binaries = [('build_tools/ffmpeg.exe', '.'), ('build_tools/wkhtmltopdf.exe', '.')]
hiddenimports = ['pytorch', 'rapidocr']
